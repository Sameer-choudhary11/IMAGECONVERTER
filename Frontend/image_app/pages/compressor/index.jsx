   ...
   function handleChange2(e)
    ...
    async function Download()
    {
      ...
      Form.append("ImgId",Img_Id);                
       await axios("http://localhost:8000/download_com", {
        method:"POST",
        data:Form,
        responseType: 'blob',          
      }).then((d)=>{        
    ...
    return(<>
    <Navbar />
    {quality>100?<><div className="bg-red-600 px-4 py-3 text-white">
  <p className="text-center text-sm font-medium">
    {quality} equal to 100 or less than 100
  </p>
</div></>:<></>}
  ...
  something went wrong please try again
    ...
    {file==undefined?<><div className="lg:col-span-2 col-span-6 py-4 px-2">
            ...
            <div className="container p-4">
                <h1 className="text-2xl fw-bold py-2 text-indigo-600">Compress Image</h1>
